                ...
                <div>
                    <form action="{{route('questions.store')}}" method="POST">
                        ...
                        <div class="flex justify-between mb-1">
                            ...
                            <input class="w-9/12 @error('title') invalid @enderror" type="text" name="title" id="questiontitle" placeholder="title...">
                        </div>
                        @error('title')
                        ...
                        <div class="flex justify-between mb-1">
                            ...
                            <textarea class="w-9/12 @error('body') invalid @enderror" name="body" id="questionbody" cols="30" rows="10"></textarea>
                        </div>
                        @error('body')
                                <div class="text-sm mb-2 text-center text-red-600">{{ $message }}</div>
                        @enderror
